...
export default Vue.extend({
    ...
    methods: {
        ...
        t: function (str: string, args?: any) {
            if (args) {
                return this.$t(`components.EEG.EegSidebarItem.${str}`, args)
            } else {
                return (this.$t('components.EEG.EegSidebarItem') as any)[str]
            }
        },
    },
    mounted () {
...
.medimg-viewer-sidebar-item {
    ...
    .medimg-viewer-sidebar-details {
        ...
        .medimg-viewer-sidebar-details > div:nth-child(3) {
            font-size: 12px;
            margin-top: 5px;
