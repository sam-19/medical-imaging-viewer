...
declare module 'cornerstone-core' {
     ...
     * @param options
     */
    function enable(element: HTMLElement, options?: {renderer?: 'webgl'}): void
     ...
     * @param dataType A string name for an arbitrary set of data
     */
    function removeElementData(element: HTMLElement, dataType: string): void
     ...
     */
    function addEnabledElement(enabledElement: EnabledElement): void
     ...
     */
    function removeLayer(element: HTMLElement, layerId: string): void
     ...
     * @param layerId The unique identifier for the layer
     */
    function setActiveLayer(element: HTMLElement, layerId: string): void
     ...
     * @param layerId The unique identifier for the layer
     */
    function setLayerImage(element: HTMLElement, image: Image, layerId?: string): void
     ...
     */
    function registerImageLoader(scheme: string, imageLoader: Function): void
     ...
     * @param element The DOM element enabled for Cornerstone
     */
    function invalidate(element: HTMLElement): void
     ...
     */
    function resize(element: HTMLElement, forceFitToWindow?: boolean): void
     ...
     */
    function setToPixelCoordinateSystem(enabledElement: EnabledElement, context: CanvasRenderingContext2D, scale?: number): void
     ...
     */
    function updateImage(element: HTMLElement, invalidated: boolean): void
     ...
     */
    function pixelDataToFalseColorData(image: Image, lookupTable: colors.LookupTable): void
     ...
     */
    function convertToFalseColorImage(element: HTMLElement, colormap: string | Colormap): void
